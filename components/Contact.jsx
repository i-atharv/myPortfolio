...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "4d64b859-5239-49f2-9744-4ccbfbb0ee00");
    ...
    return (
        ...
        id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto dark:bg-none'>
            ...
            className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
                I’m always excited to collaborate on innovative projects and share knowledge. Whether you have an idea, a question, or an opportunity in mind, I’d love to hear from you. Let’s connect and turn your vision into reality!
            </motion.p>
            ...
            onSubmit={onSubmit} className='max-w-2xl mx-auto'>
                <div className='grid grid-cols-about gap-6 mt-10 mb-8'>
